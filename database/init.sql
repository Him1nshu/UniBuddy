-- UniBuddy Database Schema
-- Run this script once to initialise the database for a fresh setup.
...
CREATE TABLE IF NOT EXISTS FacilityIssues (
    ...
    description TEXT         NOT NULL,
    category    ENUM('electrical', 'plumbing', 'cleanliness', 'infrastructure', 'other') DEFAULT 'other',
